...
* `disableKeyboardDateSelection` stop `keydown` events being passed to Pikaday instance, useful when picker is always visible in a container element (default: false)
